...
| Configure Swiss AI Platform | [swiss-ai-platform-setup.md](setup-guides/swiss-ai-platform-setup.md) |
...
- [swiss-ai-platform-setup.md](setup-guides/swiss-ai-platform-setup.md) — Swiss AI Platform setup with `api_url`
